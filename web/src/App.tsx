  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/flashcards/create" element={<PrivateRoute><CreateFlashcardPage /></PrivateRoute>} />
        <Route path="/flashcards/create/:deckId" element={<PrivateRoute><CreateFlashcardPage /></PrivateRoute>} />
